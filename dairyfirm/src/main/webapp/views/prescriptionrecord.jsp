...
function createit() {
  var HTML_Width = $(".html-content").width()-10;
    ...
    html2canvas($(".html-content")[0]).then(function (canvas) {
        ...
        var pi= $("#prid").val();
        var r= pi+"prescriptionrecord"+".pdf"; 
       pdf.save(r);
        $(".html-content").hide();
    });
}
...
<c:forEach items="${prescriptionrecord}" var="mr" varStatus="loop">
<tr>
...
<c:forEach items="${prescriptionrecord}"  var="drug">
<tr>
<td><b>animal id:${drug.ap.anid}</b> <br/>
<b>type:${drug.ap.type}</b> <br/>
<b>color:${drug.ap.color}</b> <br/>
<b>gender:${drug.ap.gender}</b> <br/>
<b>age(month):${drug.ap.age}</b> <br/>
<b>consult:${drug.consult}</b>
</td>
<td><b>drugtype::${drug.drugtype}</b> <br/><b>drugname::${drug.drugname}</b> <br/><b>rules::${drug.rules}</b><br/>
<b>price(tk):${drug.ap.chest}</b> <br/>
</td>
<td><b>${drug.ap.stringpresdate}</b></td>
<td><b>${drug.stringlastdate}</b></td>
<td><b>${drug.instruction}</b></td>
<td><b>${drug.doctor}</b></td>
</tr>
</c:forEach>
