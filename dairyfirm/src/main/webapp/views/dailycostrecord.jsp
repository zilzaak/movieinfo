...
<h4>Daily cost records</h4>
<b style="color:maroon;">total record::${tr}         present date::${todays}</b> <br/>
<b style="color:maroon;">total cost(tk)::${tp}        <br/>
...
<c:forEach items="${dailycostrecord}" var="mr" varStatus="loop">
<tr>
...
<c:forEach items="${dailycostrecord}"  var="drug">
<tr>
<td><b>${drug.itemname}</b></td>
<td><b>${drug.amount}</b></td>
<td><b>${drug.type}</b></td>
<td><b>${drug.cost}</b></td>
<td><b>${drug.stringcostdate}</b></td>
</tr>
</c:forEach>
