...
<b style="color:maroon;">total price(tk)::${tp}  <br/>
<div style="font-size:.80em;background-color:aliceblue;margin-left:10%;">
<table class="table table-borderless table-sm table-responsive" border="1" >
<c:forEach items="${animalrecord}" var="mr" varStatus="loop">
<tr>
...
<c:forEach items="${animalrecord}"  var="drug">
<tr>
<td><b>${drug.anid}</b></td>

<td>
<b>type::${drug.type}</b> <br/>
<b>gender::${drug.gender}</b> <br/>
<b>species::${drug.jaat}</b> <br/>
<b>age (month)::${drug.agem}</b> <br/>
</td>

<td><b>${drug.chest}</b></td>
<td><b>${drug.source}</b> <br/>
<b>seller name:${drug.sellername}</b> <br/>
<b>market name:${drug.marketname}</b> 
</td>
<td><b>${drug.createdstring}</b></td>
</tr>
</c:forEach>
