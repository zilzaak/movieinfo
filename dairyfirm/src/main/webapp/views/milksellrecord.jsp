...
<h4>milk selling records</h4>
<b style="color:maroon;">total record::${tr}         present date::${todays}</b> <br/>
<b style="color:maroon;">total sold(tk)::${tp}       total due(tk)::${td}</b> <br/>
...
<c:forEach items="${milksellrecord}" var="mr" varStatus="loop">
<tr>
...
<c:forEach items="${milksellrecord}"  var="drug">
<tr>
<td><b>${drug.amount}</b></td>
<td><b>${drug.totalprice}</b></td>
<td><b>${drug.rate}</b></td>
<td><b>${drug.stringselldate}</b></td>
<td><b>${drug.buyername}</b></td>
<td><b>${drug.due}</b></td>
<td><b>${drug.contact}</b></td>
</tr>
</c:forEach>
